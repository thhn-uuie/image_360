            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">TRÌNH DIỄN ẢNH 360<span></span></h5>
                        <p> Đưa đến mọi người cái nhìn đa chiều, sống động về thế giới xung quanh. </p>
                    </div>
                </div>

                <div class="col-xs-12 col-sm-6 col-md-4" style="padding-left: 6vw;">
                    <div class="widget no-box">
                        <h5 class="widget-title">THÔNG TIN<span></span></h5>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="widget no-box">
                        ...
                        <p><a href="mailto:nguyenthithuhien_t65@hus.edu.vn" title="glorythemes">nguyenthithuhien_t65@hus.edu.vn</a></p>
