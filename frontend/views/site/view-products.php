...
<head>
    ...
    <!-- Bootstrap styles -->
    <link href="products/products/assets/css/bootstrap.css" rel="stylesheet"/>
    <!-- Customize styles -->
    <link href="products/style.css" rel="stylesheet"/>
    <!-- font awesome styles -->
    <link href="products/products/assets/font-awesome/css/font-awesome.css" rel="stylesheet">
    <!--[if IE 7]>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="products/products/assets/ico/favicon.ico">
</head>
<body>
        ...
        <div class="well well-small">
                    ...
                    <div id="myCarousel" class="carousel slide cntr">
                        <div class="carousel-inner">
                            <div class="item active">
                                <a href="#"> <img src="products/assets/img/a.jpg" alt="" style="width:100%"></a>
                            </div>
                            <div class="item">
                                <a href="#"> <img src="products/assets/img/b.jpg" alt="" style="width:100%"></a>
                            </div>
                            <div class="item">
                                <a href="#"> <img src="products/assets/img/e.jpg" alt="" style="width:100%"></a>
                            </div>
                        </div>
            ...
            <div id="myTabContent" class="tab-content tabWrapper">
                ...
                <div class="tab-pane fade" id="profile">
                    <div class="row-fluid">
                        <div class="span2">
                            <img src="products/assets/img/d.jpg" alt="">
                        </div>
                        <div class="span6">
                            <h5>Product Name </h5>
                            <p>
                ...
                <div class="tab-pane fade" id="cat1">
                    ...
                    <div class="row-fluid">
                        <div class="span2">
                            <img src="products/assets/img/b.jpg" alt="">
                        </div>
                        <div class="span6">
                            <h5>Product Name </h5>
                            <p>
                    ...
                    <div class="row-fluid">
                        <div class="span2">
                            <img src="products/assets/img/a.jpg" alt="">
                        </div>
                        <div class="span6">
                            <h5>Product Name </h5>
                            <p>
...
<section class="our_client">
    ...
    <div class="row">
        <div class="span2">
            <a href="#"><img alt="" src="products/assets/img/1.png"></a>
        </div>
        <div class="span2">
            <a href="#"><img alt="" src="products/assets/img/2.png"></a>
        </div>
        <div class="span2">
            <a href="#"><img alt="" src="products/assets/img/3.png"></a>
        </div>
        <div class="span2">
            <a href="#"><img alt="" src="products/assets/img/4.png"></a>
        </div>
        <div class="span2">
            <a href="#"><img alt="" src="products/assets/img/5.png"></a>
        </div>
        <div class="span2">
            <a href="#"><img alt="" src="products/assets/img/6.png"></a>
        </div>
    </div>
</section>
...
<div class="copyright">
    <div class="container">
        <p class="pull-right">
            <a href="#"><img src="products/assets/img/maestro.png" alt="payment"></a>
            <a href="#"><img src="products/assets/img/mc.png" alt="payment"></a>
            <a href="#"><img src="products/assets/img/pp.png" alt="payment"></a>
            <a href="#"><img src="products/assets/img/visa.png" alt="payment"></a>
            <a href="#"><img src="products/assets/img/disc.png" alt="payment"></a>
        </p>
...
<script src="products/assets/js/jquery.js"></script>
<script src="products/assets/js/bootstrap.min.js"></script>
<script src="products/assets/js/jquery.easing-1.3.min.js"></script>
<script src="products/assets/js/jquery.scrollTo-1.4.3.1-min.js"></script>
<script src="products/assets/js/shop.js"></script>
</body>
</html>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="author" content="">
    <!-- Bootstrap styles -->
    <link href="products/assets/css/bootstrap.css" rel="stylesheet"/>
    <!-- Customize styles -->
    <link href="style.css" rel="stylesheet"/>
    <!-- font awesome styles -->
    <link href="products/assets/font-awesome/css/font-awesome.css" rel="stylesheet">
    <!--[if IE 7]>
    <link href="css/font-awesome-ie7.min.css" rel="stylesheet">
    <![endif]-->
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="products/assets/ico/favicon.ico">
</head>
<body>
...
<div class="container">
    ...
    <div class="row">
        <div id="sidebar" class="span3">
            ...
            <div class="well well-small"><a href="#"><img src="products/assets/img/paypal.jpg"
            ...
            <ul class="nav nav-list promowrapper">
                <li>
                    <div class="thumbnail">
                        ...
                        <img src="products/assets/img/bootstrap-ecommerce-templates.png"
                ...
                <li>
                    <div class="thumbnail">
                        <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                        <img src="products/assets/img/shopping-cart-template.png" alt="shopping cart template">
                        <div class="caption">
                            <h4><a class="defaultBtn" href="product_details.html">VIEW</a> <span class="pull-right">$22.00</span>
                            </h4>
                        </div>
                ...
                <li>
                    <div class="thumbnail">
                        <a class="zoomTool" href="product_details.html" title="add to cart"><span
                                    class="icon-search"></span> QUICK VIEW</a>
                        <img src="products/assets/img/bootstrap-template.png" alt="bootstrap template">
                        <div class="caption">
                            <h4><a class="defaultBtn" href="product_details.html">VIEW</a> <span class="pull-right">$22.00</span>
                            </h4>
                        </div>
            ...
            <div class="span4">
                <h1>
                    <a class="logo" href="index.html"><span>Twitter Bootstrap ecommerce template</span>
                        <img src="products/assets/img/logo-bootstrap-shoping-cart.png" alt="bootstrap sexy shop">
                    </a>
                </h1>
            </div>
            <div class="span4">
