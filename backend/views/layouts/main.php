                ...
                <div class="profile clearfix">
                    ...
                    <div class="profile_pic">
                        <img alt="..." class="img-circle profile_img"
                             src="<?php echo Yii::$app->homeUrl . '../../image/avatars/' . $profile_id_user->avatar ?>">
                    </div>
                        ...
                        <li class="nav-item dropdown open" style="padding-left: 15px;">
                            ...
                            <a href="javascript:" class="user-profile dropdown-toggle" aria-haspopup="true"
                               id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo Yii::$app->homeUrl . '../../image/avatars/' . $profile_id_user->avatar ?>"
                                     alt="">
                            </a>
                                ...
                                <?php if (Yii::$app->user->identity->id_role == 2): ?>
                                    ...
                                    <a class="dropdown-item"
                                       href="<?= Url::toRoute(['profile/view', 'id_user' => $profile->id_user]) ?>">
                                        Hồ sơ</a>
                                <?php endif; ?>
                                <a class="dropdown-item" href="<?php echo Yii::$app->homeUrl . '../../anh360/'?>">
